...
(function () {
    ...
    $.getJSON('http://egw.ifsc-climbing.org/egw/ranking/json.php', data => {
        ...
        data.competitions.forEach(comp => {
            ...
            event.addProp('UID');
            event.addProp('DTSTART', new Date(comp.date), { VALUE: 'DATE' });
            event.addProp('DTEND', new Date(comp.date_end), { VALUE: 'DATE' });
            event.addProp('DTSTAMP', new Date(comp.modified), { VALUE: 'DATE-TIME' });
